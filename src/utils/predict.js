import { CO2E_PER_KG_LPG, LOCATIONS, LPG_EQUIVALENT_KG_PER_M3, LPG_PRICE_PER_KG_PHP, WASTE_TYPES } from "../data/mockData";
const round = (value) => Number(value.toFixed(2));
const estimateDigesterSize = (biogasM3PerDay) => {
...
const buildFeedstockTips = (entries) => {
...
const buildMaintenanceChecklist = () => {
    return [
...
export const runMockPrediction = (entries, locationId) => {
